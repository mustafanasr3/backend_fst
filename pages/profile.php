    ...
    <div class="col-xl-4">
      ...
      <div class="card">
        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
          ...
          <img src="<?=url("upload/") . $data['image']?>" alt="Profile" class="rounded-circle">
          <h2><?=$data['name']?></h2>
          <h3><?=$data['email']?></h3>
              ...
              <form method="post" enctype="multipart/form-data" action="<?=url("controller/profile.php")?>">
                <div class="row mb-3">
                  ...
                  <div class="col-md-8 col-lg-9">
                    <img src="<?=url("upload/") . $data['image']?>" alt="Profile">
                    <div class="pt-2">
                    <label for="image_name" class="btn btn-primary text-light">
                    <i class="bi bi-upload"></i>
                      </label>
                        <span id="image_title"></span>
                         <input type="file" name="upload_img" id="image_name" class="d-none">
                         <a href="<?=url()?>" class="btn btn-danger text-light"></a>
                    </div>
                  </div>
                </div>
...
<script>
  let upload = document.querySelector("#image_name");
  let span = document.querySelector("#image_title");
  upload.addEventListener("change", function(){
    span.innerHTML= upload.files[0].name;
  })
</script>
<?php
